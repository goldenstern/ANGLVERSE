  ...
  <div class="cont" :class="{loaded: state.isLoggedIn}" v-if="state.user.balance_ngls !== null"  style="overflow-y: scroll;">
    ...
    <div class="flex-content">
      <div class="flex-item-1">
        <img src="@/assets/promo/ho/m.png" style="width: 100%;margin: 20px 0%;bottom: 0px;margin-top: -200px;">
      </div>
      <div class="wall-c active flex-item-2">
        <div class="tot-b" style="z-index: 10;font-size: 38px;">
          <p>Högle is a big fish for long time stakers. It holds some amount of Ögles and produce new sometimes, when fully charged.</p>
          <p>We give away 10 Högles and 1 Clan Öwner to ones, who will invite the most friends till December 1st. Win your own Högle!</p>
