<template>
  <div class="cont" :class="{loaded: state.isLoggedIn}" v-if="state.user.balance_ngls !== null" style="background: white;">
    ...
    <div class="flex-content">
      ...
      <div class="wall-c active flex-item-2" style="margin-top: 15vh">
        <div class="tot-b" style="z-index: 10;font-size: 38px;">
          <div style="width: 100%; text-align: center;">
            <div style="display: inline-block;">
              <item :manual="{'path':'basic/item/Coop.png','scale':2}"></item>
            </div>
          </div>
          ...
          <p><span style="font-size: 46px;font-family: 'Roboto';">Invite Some Friends</span><br>Cooperate and Win gDAO tokens!<br><br>You and your friends can receive gDAO tokens for registering at AnglVerse.<br><br>To claim your and your friends gDAO tokens they will need to register at AnglVerse by visiting your Community invite link and buy their first Eidol Egg.</p>
      ...
      <div style="width: 100%;" class="flex-item-3" :class="{long: tokenAmount > 0}">
        <div style="color: #e5c44f;font-size: 55px;width: 100%;z-index: 1000;">Your Community invite link</div>
        ...
        <div class="height-box" :class="{hidden: tokenAmount == 0}" style="position: relative;">
          <button @click="drop" style="margin-top: 40px" class="button-fixed" :class="{success: isSuccessDW, locked: isError || isSending, slocked: isSending, unlocked: isError }">
            ...
            <span v-else-if="!isSending">Claim Rewards</span> 
...
export default {
  ...
  methods: {
    ...
    drop () {
      ...
      //   .then(() => {
      //     axios
      //       .post(config.api+`/drop`, {item_id: 5})
      //       .then(() => {
      //         this.isSuccessDW = true;
      //         setTimeout(()=>{utils.update_game();}, 750)
      //         setTimeout(()=>{this.wallet();}, 1000)
      //       }).catch(error => {
